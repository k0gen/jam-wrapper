FROM --platform=linux/arm64/v8 ghcr.io/joinmarket-webui/joinmarket-webui-ui-only:latest
RUN apk add wget sudo xsel
# RUN curl -fsSL https://deb.nodesource.com/setup_16.x | sudo -E bash - && apt-get -y install nodejs && npm install http-server
